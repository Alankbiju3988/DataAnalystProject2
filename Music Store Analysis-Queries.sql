...
/* here we are actually finding the list of customers that bought the songs of best selling artist 
since its we need to join so many tables first we made a CTE to find the best selling artist and 
we used that CTE to find the customers that bought the songs of that best selling artist*/
